...
public class ErrorHintView extends RelativeLayout {
    ...
    class LoadFailure implements IStrategy {
        ...
        public void operate() {
            if (loadFailure == null) {
                loadFailure = LayoutInflater.from(getContext()).inflate(
    ...
    public void serverError(OperateListener listener) {
        this.mOperateListener = listener;
        mErrorHandler.operate(new ServerError());
    }
    ...
    class ServerError implements IStrategy {

        @Override
        public void operate() {
            if (serverError == null) {
                serverError = LayoutInflater.from(getContext()).inflate(R.layout.layout_server_failure, null, false);
                View view = serverError.findViewById(R.id.load_retry);
                view.setOnClickListener(new OnClickListener() {
            ...
            mContainer.removeAllViews();
            mContainer.addView(serverError, layoutParams);
        }
    }
