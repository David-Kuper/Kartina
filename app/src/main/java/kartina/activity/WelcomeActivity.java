...
import kartina.R;
import kartina.adapter.SuperViewPagerAdapter;
...
//		layout_introduct_iv3 = (ImageView) findViewById(R.id.layout_introduct_iv3);
        ...
        guide1Tx2.setText("随时随地获取");
        guide1Tx1.setText("校园资讯");
        ...
        introductVp.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
...
//			layout_introduct_iv2.setImageResource(R.drawable.icon_introduct_unfocus);
                guide2Tx2.setText("开启校园话题圈");
                guide2Tx1.setText("你来定");
                guide1Tx2.setText("");
                guide1Tx1.setText("");
                guide3Tx2.setText("");
                guide3Tx1.setText("");
                ...
                break;
            case 2:
                guide3Tx2.setText("从现在");
                guide3Tx1.setText("校园动态时刻伴随");
                guide1Tx2.setText("");
                guide1Tx1.setText("");
                guide2Tx2.setText("");
                guide2Tx1.setText("");
